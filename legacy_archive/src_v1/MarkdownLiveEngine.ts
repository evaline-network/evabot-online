...
export class MarkdownLiveEngine {
  private static instance: MarkdownLiveEngine;

  private metricsState: ILiveMetricState = {
    frankfurtCpu: '3.2%',
  ...
  public static getInstance(): MarkdownLiveEngine {
  ...
  public getMetrics(): ILiveMetricState {
  ...
  public processLiveMarkdown(markdown: string): string {
    let output = markdown;
  ...
  public renderHtmlPreview(liveMarkdown: string): string {
