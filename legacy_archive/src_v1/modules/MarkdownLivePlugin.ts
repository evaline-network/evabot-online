...
export class MarkdownLivePlugin implements IEvaBotPlugin {
  public id = 'md-live';
  public name = 'Markdown-Live Metrics & Dual-View Plugin';
  public version = '1.0.0';
  public screenId = 'tab-md-live';
  ...
  private templateEn = `# EVABOT ONLINE // REACTIVE MARKDOWN-LIVE ENGINE
