import { DEFAULT_VOICE_PLUGIN_CONFIG, VOICE_PERSONAS, AUTO_PERSONA_PROMPT, } from './VoicePluginConfig.js';
import { Config } from '../../core/Config.js';
import { GoogleAuthProvider } from '../../core/GoogleAuthProvider.js';
import { logger } from '../../core/Logger.js';
export class VoiceController {
    static settings = { ...DEFAULT_VOICE_PLUGIN_CONFIG };
    static getSettings() {
    ...
    static async handleRequest(req, res, pathname) {
        ...
        if (pathname === '/api/voice/config' && req.method === 'GET') {
            ...
            const activePersonaSpec = this.settings.activePersona === 'auto'
                ? null
                : VOICE_PERSONAS[this.settings.activePersona];
            sendJson(200, {
                enabled: this.settings.enabled,
                model: this.settings.model,
                endpoint: this.settings.endpoint,
