...
export class LiveMarkdownEngine {
    ...
    currentLanguage = 'en';
    currentViewMode = 'BEAUTIFUL_HYPER_UI';
    static getInstance() {
    ...
    processLiveMarkdown(markdownTemplate) {
...
`;
    ...
    renderByMode(liveMarkdown, mode) {
    ...
    compileToRawMarkdownView(liveMarkdown) {
...
`;
    ...
    compileToBeautifulHtml(liveMarkdown) {
        const lines = liveMarkdown.split('\n');
