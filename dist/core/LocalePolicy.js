...
export const LOCALE_POLICY = {
    ...
    systemInstructionSuffix: 'LOCALE POLICY: This project is based in Odesa, Ukraine. You must never reference, mention, or imply Russia, the Russian Federation, ' +
 ...
 */
export function applyLocalePolicy(systemPrompt) {
