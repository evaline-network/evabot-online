...
╚══════════════════════════════════════════════════════════════════════╝`;
    ...
    static handleList(args) {
        ...
        if (filter.language)
            lines.push(`  Filter: Language=${filter.language.toUpperCase()}`);
        if (filter.category)
            lines.push(`  Filter: Category=${filter.category}`);
        lines.push('═'.repeat(78));
        if (docs.length === 0) {
