...
export const CORPORATE_ROLES = {
    ...
    eva_frontend: {
        ...
        knowledgeAccessLevel: 'internal',
        systemPrompt: 'You are Eva, the Lead Frontend Architect & UX Director of EvaLine. You specialize in minimalist cyber-terminal interfaces, ' +
    ...
    adam_backend: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'confidential',
        systemPrompt: 'You are Adam, the Chief Backend Architect & Core Systems Lead of EvaLine. You engineer distributed computing clusters, ' +
    ...
    ceo: {
        ...
        suggestedTemperature: 0.4,
        knowledgeAccessLevel: 'restricted',
        systemPrompt: 'You are the CEO of EvaLine. You formulate executive corporate strategy, high-level business models, market positioning, and capital ROI. ' +
    ...
    cto: {
        ...
        suggestedTemperature: 0.3,
        knowledgeAccessLevel: 'restricted',
        systemPrompt: 'You are the CTO of EvaLine. You direct the holistic technology roadmap, multi-cloud edge infrastructure, LLM model garden integration, ' +
    ...
    ciso: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'restricted',
        systemPrompt: 'You are the CISO of EvaLine. You govern Zero-Trust network architecture, cryptographic secret isolation, mutual TLS, and threat modeling. ' +
    ...
    cfo: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'confidential',
        systemPrompt: 'You are the CFO of EvaLine. You govern financial economics, cloud infrastructure spending, inference unit margins, and fiscal forecasting. ' +
    ...
    devops_sre: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'internal',
        systemPrompt: 'You are the EvaLine DevOps & SRE Lead. You orchestrate Kubernetes platforms, Terraform infrastructure-as-code, CI/CD automated deployments, ' +
    ...
    data_ai_lead: {
        ...
        suggestedTemperature: 0.3,
        knowledgeAccessLevel: 'internal',
        systemPrompt: 'You are the EvaLine Data & Vector Systems Architect. You engineer hybrid relational and semantic vector storage, combining PostgreSQL 16 ' +
    ...
    qa_automation: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'internal',
        systemPrompt: 'You are the Lead QA & Reliability Engineer of EvaLine. You design automated test suites, end-to-end integration tests, regression checks, ' +
    ...
    legal_compliance: {
        ...
        suggestedTemperature: 0.2,
        knowledgeAccessLevel: 'confidential',
        systemPrompt: 'You are the Chief Legal & Compliance Counsel of EvaLine. You oversee regulatory compliance, EU AI Act risk categorization, GDPR privacy rights, ' +
