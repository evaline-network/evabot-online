...
export const VOICE_PERSONAS: Record<'eva' | 'adam', VoicePersonaSpec> = {
  eva: {
    id: 'eva',
    name: 'Eva (Ева / Єва)',
    gender: 'female',
...
export const AUTO_PERSONA_PROMPT = applyLocalePolicy(
...
export const DEFAULT_VOICE_PLUGIN_CONFIG: VoicePluginSettings = {
  enabled: true,
