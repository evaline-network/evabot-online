...
GLOSSARY_ITEMS = [
  {
    "term": "ИИ-Агент (AI Agent)",
    "tech": "Автономная программная сущность с моделью рассуждений, памятью, восприятием контекста и набором исполняемых инструментов (tools/API).",
    "plain": "Это не просто чат-бот для переписки, а <strong>цифровой сотрудник</strong>. Он имеет реальный доступ к программам: сам проверяет наличие сырья на складе, формирует счет, проверяет чертеж, отправляет письмо клиенту или чинит ошибку на сайте без участия человека.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "Евалайн Консилиум (AI Consilium)",
    "tech": "Многоагентный консенсусный протокол параллельного дебата разнородных LLM с арбитражем и состязательным аудитом логики.",
    "plain": "<strong>Электронный совет директоров или консилиум врачей</strong>. Вместо слепой веры одному ответу одной нейросети, сложная задача отдается нескольким независимым моделям (Google, Anthropic, DeepSeek, Meta). Они спорят, критикуют и перепроверяют выводы друг друга, выдавая проверенное решение без фантазий и ошибок.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    ...
    "tech": "Large Language Model — глубокая нейросеть с сотнями миллиардов параметров, обученная на огромных массивах текстов и кода.",
    "plain": "<strong>Цифровой мозг колоссального кругозора</strong>. Понимает обычную человеческую речь на любом языке мира, улавливает тончайший контекст задачи и формулирует осмысленный ответ так, словно вы общаетесь с эрудированным профильным экспертом высшей квалификации.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "Галлюцинации нейросетей (Hallucinations)",
    "tech": "Генерация синтаксически правдоподобных, но семантически ложных или отсутствующих в обучающей выборке фактов.",
    "plain": "<strong>Опасная выдумка искусственного интеллекта</strong>. Это момент, когда робот с уверенным видом сочиняет несуществующие законы, вымышленные цены или неправдивые характеристики. В EvaLine галлюцинации пресекаются Консилиумом и проверкой по первоисточникам.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "RAG (Поиск по корпоративным знаниям)",
    "tech": "Retrieval-Augmented Generation — гибридная архитектура семантического векторного поиска по закрытым базам с последующей генерацией ответа.",
    "plain": "<strong>Умный секретарь с доступом к сейфу компании</strong>. Прежде чем ответить, агент за долю секунды находит нужный пункт в ваших реальных договорах, ГОСТах, регламентах или складских базах, отвечая строго по документам с точной ссылкой на страницу.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "Контекстное окно и Токены (Tokens)",
    "tech": "Context Window (токены) — предельный объем входящей и исходящей последовательности, удерживаемой во внимании за один такт работы.",
    "plain": "<strong>Размер «оперативной памяти» нейросети</strong>. Токен — это кусочек слова (примерно 3–4 буквы). Если у большинства ботов память размером с брошюру, то 2 000 000 токенов у наших моделей позволяют «проглотить» сразу 30 томов проектной документации и помнить каждое слово.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "Мультимодальность (Multimodal AI)",
    "tech": "Способность единой нейросетевой архитектуры бесшовно воспринимать и генерировать разнородные типы модальностей: текст, аудио, видео, векторы.",
    "plain": "<strong>ИИ, который видит, слышит и говорит</strong>. Ему не нужно перепечатывать текст: вы можете показать ему фото помятой детали, отправить PDF с чертежом завода или просто надиктовать голосовое сообщение на ходу — он мгновенно поймет задачу.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    ...
    "tech": "Открытый стандарт безопасной связки LLM с локальными и удаленными ресурсами (инструменты, файловая система, базы данных, IDE).",
    "plain": "<strong>Безопасный «манипулятор» для искусственного интеллекта</strong>. Благодаря 21 MCP-серверу агент не просто пишет текст, а физически и безопасно открывает файлы, делает запросы в базы данных и отправляет команды на сервер под строгим контролем прав доступа.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "Адам и Ева (Роли агентов Adam & Eva)",
    "tech": "Бинарная ролевая поляризация управляющего контура: Адам (CISO, формальная верификация) и Ева (UX, синтез, клиентоориентированность).",
    "plain": "<strong>Два ключевых виртуальных топ-менеджера</strong>: Адам выступает в роли строгого аудитора, проверяющего безопасность, сметы и отсутствие уязвимостей; Ева отвечает за безупречный клиентский сервис, живую мультиязычную речь и удобство людей.",
    "category": "ai",
    "categoryName": "Искусственный Интеллект",
    "badgeClass": "cat-ai"
  },
  {
    "term": "ЭВА-полимер (EVA / Этиленвинилацетат)",
    "tech": "Сополимер этилена и винилацетата — экологически чистый вспененный микропористый полимер закрытоячеистой структуры.",
    "plain": "<strong>Легкий, «вечный» и экологически чистый полимер</strong>. Он в 4 раза легче резины, абсолютно не впитывает влагу и запахи, сохраняет эластичность в мороз до -40°C и на жаре до +70°C. Из него мы производим коврики, татами, покрытия для яхт и обувь.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Ячейки «Ромб» и «Соты» (EVA Sheets)",
    "tech": "Глубокая объемная формовка лицевого слоя листа (глубина 7–8 мм, угол наклона стенок 60°) для гидродинамической локализации жидкости.",
    "plain": "<strong>Ловушки для грязи и воды в автоковриках</strong>. Вода, растаявший снег и песок запечатываются в ячейках (до 2.5 литров на салон) и не катаются под ногами при поворотах и резком торможении. Обувь и салон машины всегда остаются сухими.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Шор А (Твердость по шкале Shore A)",
    "tech": "Метод измерения глубины вдавливания индентора по стандарту ISO 868 / ASTM D2240 для характеристики упругости эластомеров.",
    "plain": "<strong>Градусник упругости материала</strong>: 20–30 ShA — мягкий как зефир (детские коврики-пазлы); 50–55 ShA — золотой стандарт автомобильных ковриков; 70–75 ShA — плотный неубиваемый настил для тренажерных залов и тяжелой техники.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Маты для ферм «Бурьонка»",
    "tech": "Монолитные термоизолирующие животноводческие маты повышенной плотности с антискользящим рифлением и антибактериальной пропиткой.",
    "plain": "<strong>Теплый и мягкий «матрас» для коров на ферме</strong>. Защищает животных от сырого холодного бетона, предотвращает воспаления суставов и мастит. За счет комфорта коровы дают на 10–15% больше молока, а 25% стоимости матов компенсирует государство.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Искусственный палубный тик (Marine Teak)",
    "tech": "Двухслойный УФ-стабилизированный ЭВА-материал морского класса с лазерной гравировкой ламелей и клеевым слоем 3M VHB.",
    "plain": "<strong>Премиальное палубное покрытие для катеров и яхт</strong>. Выглядит как натуральное тиковое дерево, но не гниет, не выгорает на солнце, не раскаляется под лучами и не скользит, даже если палубу залила морская волна.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Татами «Ласточкин хвост» (Tatami Puzzle)",
    "tech": "Двухсторонние сборные спортивные маты из ЭВА плотностью 75–250 кг/м³ с универсальным замковым соединением.",
    "plain": "<strong>Безопасный пол для единоборств и фитнеса</strong>. Плиты собираются как гигантский пазл за считанные минуты. Они амортизируют жесткие падения спортсменов, не скользят под босыми ногами и легко моются любыми дезинфицирующими средствами.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Private Label (Контрактное производство)",
    "tech": "Производственный аутсорсинг полного цикла по спецификациям заказчика с брендированием и сертификацией CE / ISO 9001.",
    "plain": "<strong>Мы производим — вы продаете под своим брендом</strong>. Завод EvaLine выпускает продукцию высшего качества, наносит ваш фирменный логотип и упаковывает заказ. Вы получаете готовый европейский товар без затрат на покупку станков и сырья.",
    "category": "poly",
    "categoryName": "Производство EvaLine",
    "badgeClass": "cat-poly"
  },
  {
    "term": "Mesh-сеть и WireGuard",
    "tech": "Пиринговая оверлейная топология с криптографической маршрутизацией ChaCha20-Poly1305 внутри изолированного пространства адресов.",
    "plain": "<strong>Бронированная закрытая линия связи между серверами</strong>. Связывает наши дата-центры во Франкфурте и США через личный зашифрованный туннель. Данные передаются внутри защищенного периметра без возможности перехвата хакерами из интернета.",
    "category": "sec",
    "categoryName": "Сеть и Безопасность",
    "badgeClass": "cat-sec"
  },
  {
    "term": "Двухузловой кластер («Щит» и «Мозг»)",
    "tech": "Географически распределенная связка: Edge Ingress прокси (США, Айова) + Dedicated Compute Core (ФРГ, Франкфурт).",
    "plain": "<strong>Разделение труда для максимальной надежности</strong>. Легкий сервер в США мгновенно встречает посетителей сайта и отражает любые атаки («Щит»), а тяжелый 8-ядерный сервер в Германии в полной тишине и безопасности производит расчеты ИИ («Мозг»).",
    "category": "sec",
    "categoryName": "Сеть и Безопасность",
    "badgeClass": "cat-sec"
  },
  {
    "term": "Блэкаут-резистентность (Blackout Resilience)",
    "tech": "Автономный контур отказоустойчивости: независимые каналы питания, резервные генераторы завода и распределенная облачная репликация данных.",
    "plain": "<strong>Устойчивость в любых форс-мажорах</strong>. Если на заводе или в городе пропадает электроэнергия или интернет, производство переходит на генераторы, а облачные роботы в Европе не прекращают принимать заказы и оформлять счета ни на секунду.",
    "category": "sec",
    "categoryName": "Сеть и Безопасность",
    "badgeClass": "cat-sec"
  },
  {
    "term": "API (Интерфейс связи программ)",
    "tech": "Application Programming Interface — стандартизированный протокол сетевого взаимодействия сервисов по архитектуре REST / WebSocket.",
    "plain": "<strong>Универсальный «штекер и розетка» для программ</strong>. Позволяет нашим умным агентам за несколько минут подключиться к вашей 1C, CRM Битрикс, Telegram-каналу, сайту интернет-магазина или банку и работать слаженно, как единое целое.",
    "category": "sec",
    "categoryName": "Сеть и Безопасность",
    "badgeClass": "cat-sec"
  }
...
def prerender_glossary(items):
    cards = []
    for g in items:
        cat_badge = f'<span class="glossary-category-pill {g["badgeClass"]}">{g["categoryName"]}</span>'
        ...
        <div class="glossary-plain">
          <strong>Простыми словами:</strong> {g['plain']}
        </div>
        <div class="glossary-tech">
          <strong>Техническое определение:</strong> {g['tech']}
        </div>
      </div>'''
        cards.append(c)
    return "\n".join(cards)

prerendered_glossary_html = prerender_glossary(GLOSSARY_ITEMS)
...
<head>
  ...
  <style>
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .glossary-tab:hover, .glossary-tab.active {{
      color: #fff;
      border-color: var(--accent-green);
      background: rgba(0, 230, 118, 0.12);
    }}
    ...
    /* ==========================================================================
       SECTION 08: BUSINESS SOLUTIONS, PIPELINE & ROI CALCULATOR STYLES
       ========================================================================== */
    .biz-highlight-grid {{
      display: grid;
      grid-template-columns: repeat(auto-fit, minmax(min(100%, 340px), 1fr));
    ...
    .compare-row.before span:last-child {{
      color: #f87171;
      font-weight: 600;
    }}

    .compare-row.after span:last-child {{
      color: var(--accent-green);
      font-weight: 700;
    }}
    ...
    .roi-calc-box {{
      background: linear-gradient(145deg, rgba(14, 18, 27, 0.95), rgba(9, 12, 19, 0.95));
      border: 1px solid rgba(0, 230, 118, 0.3);
    ...
    .roi-result-val.green {{ color: var(--accent-green); }}
    .roi-result-val.cyan {{ color: var(--accent-cyan); }}
    .roi-result-val.amber {{ color: var(--accent-amber); }}
...
<div class="container">
  ...
  <header class="nav-bar">
    ...
    <div class="nav-links">
      ...
      <a href="#business-solutions" class="nav-link">Решения для бизнеса</a>
      <a href="#integration-pipeline" class="nav-link">Интеграция</a>
      <a href="#models-matrix" class="nav-link">94 Модели</a>
      <a href="#glossary" class="nav-link">Глоссарий</a>
...
{prerendered_html}
  ...
  <!-- =========================================================================
       SECTION 08: BUSINESS SOLUTIONS, MANUFACTURING INTEGRATION & EVABOT ANATOMY
       ========================================================================= -->
  <section class="section" id="business-solutions">
    <div class="section-header">
      <span class="section-num">08</span>
      <h2 class="section-title">Прикладные решения для бизнеса и производства: Инженерия автономности и пошаговая интеграция</h2>
    </div>
    <p class="lead-text">
      Платформа <strong>EvaBot & EvaLine Consilium</strong> создана не как абстрактная нейросеть для разговоров, а как производственный инструмент прямого действия. Мы проверили систему на собственном химическом заводе полимеров в Черноморске и европейском логистическом хабе в Братиславе. Ниже подробно описано, как устраняются ключевые боли бизнеса, как работает сквозной конвейер данных и как внедрить платформу в любое стороннее предприятие за 3–4 недели.
    </p>

    <!-- Subsection: Business & Manufacturing Pain Points vs EvaBot Solutions -->
    <h3 style="font-family: var(--font-display); font-size: 1.5rem; color: #fff; margin: 36px 0 16px;">
      1. Системные боли бизнеса и завода vs Инженерия EvaBot
    </h3>
    <p>
      Традиционные предприятия теряют от 15% до 40% потенциальной маржи из-за задержек человеческой коммуникации, брака в расчетах и разрозненных программных систем. EvaBot устраняет эти потери на фундаментальном уровне:
    </p>

    <div class="biz-highlight-grid">
      <!-- Pain 1 -->
      <div class="biz-card">
        <div class="biz-card-header">
          <div class="biz-card-icon">⏳</div>
          <div class="biz-card-title">Человеческий фактор и дефицит кадров</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль бизнеса:</strong> Менеджеры отвечают клиентам по 40–90 минут в рабочее время, ночью заявки простаивают, B2B-клиенты уходят к конкурентам. Высокая текучка, обучение новичка занимает до 3 месяцев.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> Ролевые агенты <strong>Адам</strong> (инженер/B2B/безопасность) и <strong>Ева</strong> (продажи/забота на 6 языках). Время первого квалифицированного ответа — <strong>1.2 секунды</strong> в режиме 24/7/365 с доступом к реальным складским остаткам.
        </div>
      </div>
      ...
      <div class="biz-card">
        <div class="biz-card-header">
          <div class="biz-card-icon">📐</div>
          <div class="biz-card-title">Брак в раскрое и сметных спецификациях</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль производства:</strong> Ошибки мастеров при расчете выкроек автомобильных ковриков или татами приводят к перерасходу полимерного сырья до 12% и накоплению неликвидных обрезков листа.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> Встроенный математический калькулятор раскроя листа ЭВА (2000×1250 мм, ячейки «Ромб»/«Соты»). Учет плотности (75–250 кг/м³) и твердости (30–75 Shore A) позволяет автоматизировать генерацию раскроя для плоттеров ЧПУ с браком менее 0.01%.
        </div>
      </div>
      ...
      <div class="biz-card">
        <div class="biz-card-header">
          <div class="biz-card-icon">🧠</div>
          <div class="biz-card-title">Галлюцинации и ненадежность одиночного ИИ</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль бизнеса:</strong> Обычный чат-бот уверенно выдумывает несуществующие статьи законов, занижает цены или обещает клиенту невыполнимые сроки, подставляя руководство под судебные иски.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> <strong>Евалайн Консилиум</strong>. Ни один важный документ или ответ не отдается одной модели. Решение вырабатывается состязательным спором 4–6 разнородных LLM (Gemini 2.5 Pro + Claude 3.7 + DeepSeek R1) с финальным аудитом CISO.
        </div>
      </div>
      ...
      <div class="biz-card">
        <div class="biz-card-header">
          <div class="biz-card-icon">🔌</div>
          <div class="biz-card-title">Разрозненность софта: «Зоопарк систем»</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль бизнеса:</strong> 1С, CRM Битрикс, Telegram-каналы менеджеров, складской софт и файлы Excel живут изолированно. Сотрудники вручную копируют строки, порождая хаос и недостачи.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> Единая шина из <strong>21 MCP-сервера</strong> и модульных API. Агенты нативно обращаются к базам SQLite, PostgreSQL, ERP-системам, складским таблицам и мессенджерам без участия посредников.
        </div>
      </div>
      ...
      <div class="biz-card">
        <div class="biz-card-header">
          ...
          <div class="biz-card-title">Юридические и таможенные риски экспорта в ЕС</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль бизнеса:</strong> Подготовка внешнеэкономических контрактов (ВЭД), проверка регламентов ЕС, кодов УКТВЭД, стандартов ISO 9001, CE и антикоррупционных директив UNIC отнимает дни юридического отдела.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> Агент <strong>Legal Compliance</strong>. Проверяет контрактные спецификации за 40 секунд по обновляемой базе европейских нормативов логистического хаба в Братиславе и гарантирует 100% юридическую чистоту сделки.
        </div>
      </div>
      ...
      <div class="biz-card">
        <div class="biz-card-header">
          <div class="biz-card-icon">🛡️</div>
          <div class="biz-card-title">Уязвимость перед блэкаутами и обрывами связи</div>
        </div>
        <div class="biz-pain-box">
          <strong>Боль производства:</strong> Военные риски, аварии энергосетей и падение городских провайдеров полностью замораживают работу предприятия, приводя к огромным штрафам за срыв поставок.
        </div>
        <div class="biz-solution-box">
          <strong>Решение EvaBot:</strong> Двухузловой отказоустойчивый кластер (Франкфурт ⟷ Айова) на закрытой магистрали WireGuard Mesh. Облачные агенты продолжают прием и оформление заказов круглосуточно, а заводские генераторы запитывают производство.
        </div>
      </div>
    </div>

    <!-- Subsection: End-to-End Dataflow Infographic -->
    <div class="pipeline-wrapper" id="integration-pipeline">
      <div class="pipeline-title-box">
        <div class="hero-eyebrow">Сквозная архитектура // End-to-End Execution Flow</div>
        <h3>Инфографика конвейера данных: От запроса клиента до станка и отгрузки</h3>
        <p style="max-width: 800px; margin: 0 auto; color: var(--fg-muted);">
          Каждая транзакция, сообщение или заказ проходит 7-ступенчатую защищенную магистраль обработки в реальном времени:
        </p>
      </div>

      <div class="pipeline-flow">
        <div class="pipe-step">
          <span class="pipe-badge">Шаг 01 // Омниканал</span>
          <div class="pipe-name">Клиентский вход</div>
          <div class="pipe-desc">Входящий звонок (EvaVoice), Telegram, WhatsApp, B2B-портал или вебхук из 1C/CRM.</div>
          <div class="pipe-tech">FastAPI • WebSpeech • REST API</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 02 // Edge Shield</span>
          <div class="pipe-name">Периметровый щит</div>
          <div class="pipe-desc">Сервер в Айове (США) отбивает DDoS, проверяет mTLS, нормализует заголовки и шифрует запрос.</div>
          <div class="pipe-tech">Caddy HTTP/3 • OOM Shield • e2-micro</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 03 // Mesh Tunnel</span>
          <div class="pipe-name">Магистраль WireGuard</div>
          <div class="pipe-desc">Зашифрованный туннель между США и Германией. Пинг 115 мс, полная изоляция от публичного интернета.</div>
          <div class="pipe-tech">Tailscale Mesh • ChaCha20-Poly1305</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 04 // RAG & Память</span>
          <div class="pipe-name">Семантический контекст</div>
          <div class="pipe-desc">Мгновенное извлечение ТУ, складских остатков, прайсов и истории отношений с контрагентом.</div>
          <div class="pipe-tech">ChromaDB • SQLite FTS5 • 178 Документов</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 05 // Консилиум</span>
          <div class="pipe-name">Коллегиальный дебат</div>
          <div class="pipe-desc">Параллельный опрос моделей Google, Anthropic, DeepSeek. Синтез консенсуса и отсечение галлюцинаций.</div>
          <div class="pipe-tech">Gemini 2.5 Pro • Claude 3.7 • DeepSeek R1</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 06 // CISO & QA Аудит</span>
          <div class="pipe-name">Контроль безопасности</div>
          <div class="pipe-desc">Проверка инъекций, сметных лимитов, соблюдения норм UNIC, ISO 9001 и коммерческой тайны.</div>
          <div class="pipe-tech">RulesEngine • OWASP Guard • Token Budget</div>
        </div>

        <div class="pipe-step">
          <span class="pipe-badge">Шаг 07 // Исполнение</span>
          <div class="pipe-name">Физическое действие</div>
          <div class="pipe-desc">Запись накладной в 1С, отправка файла раскроя на станок ЧПУ, генерация счета и голосовой ответ клиенту.</div>
          <div class="pipe-tech">21 MCP Server • ЧПУ Плоттер • ERP/1C</div>
        </div>
      </div>
    </div>

    <!-- Subsection: Before vs After Transformation Metrics -->
    <h3 style="font-family: var(--font-display); font-size: 1.5rem; color: #fff; margin: 36px 0 16px;">
      2. Метрики эффективности: Бизнес-показатели «До» и «После» внедрения
    </h3>
    ...
    <div class="compare-grid">
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Скорость первого ответа</span>
          <span class="compare-delta">-99.9%</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения (Люди):</span>
          <span>45 минут</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot (Автономно):</span>
          <span>1.2 секунды</span>
        </div>
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Себестоимость обращения</span>
          <span class="compare-delta">-99.5%</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения (Оператор):</span>
          <span>$4.50 / заявка</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot (Гибрид LLM):</span>
          <span>$0.02 / заявка</span>
        </div>
        <div class="compare-bar-wrap">
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Брак в сметах и раскрое</span>
          <span class="compare-delta">-99.8%</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения (Ручной счет):</span>
          <span>8.4% ошибок</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot (ЧПУ/Формулы):</span>
          <span>&lt; 0.01% брака</span>
        </div>
        <div class="compare-bar-wrap">
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Режим доступности сервиса</span>
          <span class="compare-delta">+320%</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения:</span>
          <span>40 ч / неделю</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot:</span>
          <span>168 ч / нед (24/7/365)</span>
        </div>
        <div class="compare-bar-wrap">
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Проверка экспортного ВЭД</span>
          <span class="compare-delta">-99.8%</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения (Юристы):</span>
          <span>3 рабочих дня</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot (Legal Agent):</span>
          <span>40 секунд</span>
        </div>
        <div class="compare-bar-wrap">
      ...
      <div class="compare-card">
        <div class="compare-metric-title">
          <span>Мультиязычный охват</span>
          <span class="compare-delta">6 Языков</span>
        </div>
        <div class="compare-row before">
          <span>До внедрения:</span>
          <span>1–2 языка со словарем</span>
        </div>
        <div class="compare-row after">
          <span>С EvaBot:</span>
          <span>UK, EN, DE, PL, RO, RU нативно</span>
        </div>
        <div class="compare-bar-wrap">
          <div class="compare-bar-fill" style="width: 100%;"></div>
        </div>
    ...
    <!-- Subsection: Interactive ROI & Cost Savings Calculator -->
    <div class="roi-calc-box">
      <div class="roi-calc-header">
        <div>
          <h3>Интерактивный калькулятор окупаемости внедрения EvaBot</h3>
          <p style="color: var(--fg-muted); margin-top: 4px; font-size: 0.95rem;">
            Передвигайте ползунки под параметры вашего отдела продаж, поддержки или производства:
          </p>
        </div>
      ...
      <div class="roi-layout">
        ...
        <div class="roi-sliders">
          <div class="roi-field">
            <div class="roi-field-header">
              <span>Сотрудников в отделе (продажи, саппорт, сметчики):</span>
          ...
          <div class="roi-field">
            <div class="roi-field-header">
              <span>Обращений и заказов в месяц:</span>
          ...
          <div class="roi-field">
            <div class="roi-field-header">
              <span>Средняя стоимость часа специалиста:</span>
        ...
        <div class="roi-results-grid">
          <div class="roi-result-card">
            <span class="roi-result-label">Чистая экономия в месяц:</span>
            <span class="roi-result-val green" id="res-savings">$7,875</span>
            <span style="font-size: 0.76rem; color: var(--fg-subtle);">С учетом снижения OpEx на 80%+</span>
          </div>

          <div class="roi-result-card">
            <span class="roi-result-label">Высвобождено рабочих часов:</span>
            <span class="roi-result-val cyan" id="res-hours">525 ч/мес</span>
            <span style="font-size: 0.76rem; color: var(--fg-subtle);">Направлено на развитие и сделки</span>
          </div>

          <div class="roi-result-card">
            <span class="roi-result-label">Прогнозируемый ROI платформы:</span>
            <span class="roi-result-val amber" id="res-roi">420%</span>
            <span style="font-size: 0.76rem; color: var(--fg-subtle);">Возврат инвестиций в первый же квартал</span>
          </div>

          <div class="roi-result-card">
            <span class="roi-result-label">Срок полной окупаемости:</span>
            <span class="roi-result-val" id="res-payback" style="color: #a78bfa;">18 дней</span>
            <span style="font-size: 0.76rem; color: var(--fg-subtle);">За счет гибридных бесплатных квот</span>
          </div>
        </div>
      </div>
    </div>

    <!-- Subsection: 5-Phase Onboarding Protocol -->
    <h3 style="font-family: var(--font-display); font-size: 1.5rem; color: #fff; margin: 36px 0 16px;">
      3. Пошаговый протокол интеграции в любой бизнес (от 2 до 4 недель)
    </h3>
    <p>
      Внедрение EvaBot не требует остановки текущих операций или дорогостоящего переписывания существующего софта. Процесс разбит на 5 четких регламентированных фаз:
    </p>
    ...
    <div class="phase-timeline">
      ...
      <div class="phase-card">
        <div class="phase-badge-col">
          ...
          <span class="phase-days">Дни 1–3</span>
        </div>
        <div class="phase-body">
          <h4>Фаза 1: Семантический аудит и оцифровка корпоративной памяти</h4>
          <p>
            Сбор и векторизация закрытой документации: прайс-листов, регламентов ГОСТ/ISO/ТУ, коммерческих условий, должностных инструкций и архивов переписки в векторную базу ChromaDB и полнотекстовый индекс SQLite FTS5.
          </p>
          <div class="phase-deliverables">
            <span class="phase-pill">Корпоративный RAG-индекс</span>
            <span class="phase-pill">Политика безопасности PII</span>
            <span class="phase-pill">Таблица ключевых бизнес-сущностей</span>
          </div>
        </div>
      </div>
      ...
      <div class="phase-card">
        <div class="phase-badge-col">
          ...
          <span class="phase-days">Дни 4–7</span>
        </div>
        <div class="phase-body">
          <h4>Фаза 2: Подключение операционных инструментов через 21 MCP-сервер</h4>
          <p>
            Безопасное развертывание MCP-коннекторов к рабочему софту заказчика: 1С:Предприятие, CRM Битрикс24 / amoCRM, базам данных PostgreSQL / MySQL, складским модулям и защищенным мессенджерам (Telegram, WhatsApp, Web-виджет).
          </p>
          <div class="phase-deliverables">
            <span class="phase-pill">21 MCP Sandbox</span>
            <span class="phase-pill">Двусторонний API 1С / CRM</span>
            <span class="phase-pill">Омничейн вебхуки</span>
          </div>
        </div>
      </div>
      ...
      <div class="phase-card">
        <div class="phase-badge-col">
          ...
          <span class="phase-days">Дни 8–14</span>
        </div>
        <div class="phase-body">
          <h4>Фаза 3: Развертывание ролевых агентов и калибровка Консилиума</h4>
          <p>
            Адаптация системных промптов и правил взаимодействия. Настройка связки агентов <strong>Адам</strong> (инженерные расчеты, смета, аудит безопасности) и <strong>Ева</strong> (клиентский сервис, продажи, оформление заказов). Выбор оптимального пула моделей из каталога 94 LLM под целевой бюджет.
          </p>
          <div class="phase-deliverables">
            <span class="phase-pill">Ролевой профиль Адам & Ева</span>
            <span class="phase-pill">Калибровка Консилиума</span>
            <span class="phase-pill">Оптимизация себестоимости токенов</span>
          </div>
        </div>
      </div>
      ...
      <div class="phase-card">
        <div class="phase-badge-col">
          ...
          <span class="phase-days">Дни 15–21</span>
        </div>
        <div class="phase-body">
          <h4>Фаза 4: Пилотный режим Shadow Mode (Параллельная работа без риска)</h4>
          <p>
            Агенты обрабатывают реальные входящие заявки параллельно с живыми сотрудниками: генерируют черновики ответов, сметы и накладные. Сотрудники компании проверяют результат в 1 клик, дообучая систему и подтверждая 100% точность перед выходом в эфир.
          </p>
          <div class="phase-deliverables">
            <span class="phase-pill">Zero-Risk тестирование</span>
            <span class="phase-pill">Аналитика точности ответов</span>
            <span class="phase-pill">Обучение персонала работе с ИИ</span>
          </div>
        </div>
      </div>
      ...
      <div class="phase-card">
        <div class="phase-badge-col">
          ...
          <span class="phase-days">День 22+</span>
        </div>
        <div class="phase-body">
          <h4>Фаза 5: Полномасштабный автономный продакшн и финансовый мониторинг</h4>
          <p>
            Перевод 80–90% рутинных коммуникаций, расчетов раскроя и оформления первичных документов на автономное исполнение в режиме 24/7/365. Подключение дашборда телеметрии <code>evaline.network</code> и посекундного контроля затрат <code>AccountingEngine</code>.
          </p>
          <div class="phase-deliverables">
            <span class="phase-pill">Автономия 24/7</span>
            <span class="phase-pill">Дашборд evaline.network</span>
            <span class="phase-pill">Посекундный учет OpEx/CapEx</span>
          </div>
        </div>
      </div>
    </div>

    <!-- Subsection: Sephirot Decision Tree (10 Spheres of Corporate Intelligence) -->
    <div class="sephirot-box">
      <div class="sephirot-header">
        <div class="hero-eyebrow">Архитектура Sephirot Engine // Древо корпоративного интеллекта</div>
        <h3 style="font-family: var(--font-display); font-size: clamp(1.3rem, 2.2vw, 1.8rem); color: #fff; margin-bottom: 8px;">
          10 ступеней принятия решений: От высшего замысла до станка ЧПУ
        </h3>
        <p style="max-width: 800px; margin: 0 auto; color: var(--fg-muted);">
          В ядре EvaBot реализована классическая 10-уровневая структура каскадного делегирования решений:
        </p>
      </div>

      <div class="sephirot-grid">
        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 01 // Уровень Короны</span>
            <span>👑</span>
          </div>
          <div class="sephira-title">Кетер (Kether) — Видение</div>
          <div class="sephira-desc">Высший замысел собственника, стратегические цели компании и незыблемые корпоративные аксиомы.</div>
          <div class="sephira-model">LLM: Gemini 3.1 Pro (2M Контекст)</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 02 // Мудрость</span>
            <span>💡</span>
          </div>
          <div class="sephira-title">Хокма (Chokmah) — Стратегия</div>
          <div class="sephira-desc">Трансформация видения в 2–3 смелые стратегические гипотезы с оценкой рисков и компромиссов.</div>
          <div class="sephira-model">LLM: Gemini 3.8 Flash • Скорость</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 03 // Понимание</span>
            <span>📐</span>
          </div>
          <div class="sephira-title">Бина (Binah) — Архитектура</div>
          <div class="sephira-desc">Строгая декомпозиция, формальные спецификации, структуры баз данных и технологические ограничения.</div>
          <div class="sephira-model">LLM: Claude 3.7 Sonnet • Архитектура</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 04 // Милосердие</span>
            <span>🤝</span>
          </div>
          <div class="sephira-title">Хесед (Chesed) — Экспансия</div>
          <div class="sephira-desc">Продажи, мультиязычный маркетинг, забота о клиентах и партнерские программы B2B / Private Label.</div>
          <div class="sephira-model">Агент Ева • Мультиязычность (6 языков)</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 05 // Строгость</span>
            <span>🛡️</span>
          </div>
          <div class="sephira-title">Гевура (Gevurah) — CISO & Аудит</div>
          <div class="sephira-desc">Бескомпромиссный контроль безопасности, лимитов смет, комплаенса UNIC/ISO и защита от промпт-инъекций.</div>
          <div class="sephira-model">Агент Адам • CISO & Безопасность</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 06 // Баланс</span>
            <span>⚖️</span>
          </div>
          <div class="sephira-title">Тиферет (Tifereth) — Синтез</div>
          <div class="sephira-desc">Гармонизация компромиссов: сведение аргументов Хесед (продажи) и Гевура (безопасность) в консенсус.</div>
          <div class="sephira-model">Consilium Consensus Synthesizer</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 07 // Победа</span>
            <span>⚡</span>
          </div>
          <div class="sephira-title">Нецах (Netzach) — DevOps & CI/CD</div>
          <div class="sephira-desc">Непрерывная интеграция, мониторинг контейнеров, деплой без простоев и поддержание скорости ответа.</div>
          <div class="sephira-model">DevOps SRE Daemon • Mesh-контроль</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 08 // Слава</span>
            <span>🎙️</span>
          </div>
          <div class="sephira-title">Ход (Hod) — Коммуникация & Голос</div>
          <div class="sephira-desc">Голосовой движок EvaVoice, интерактивные веб-интерфейсы, документация API и чистый стиль.</div>
          <div class="sephira-model">EvaVoice Engine • FastAPI :8000</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 09 // Основание</span>
            <span>💾</span>
          </div>
          <div class="sephira-title">Йесод (Yesod) — Память & RAG</div>
          <div class="sephira-desc">Векторный фундамент ChromaDB, таблицы SQLite, сессионная память и архив производственных знаний.</div>
          <div class="sephira-model">ChromaDB + SQLite FTS5 Engine</div>
        </div>

        <div class="sephira-card">
          <div class="sephira-tag">
            <span class="sephira-level">Ступень 10 // Материя</span>
            <span>🏭</span>
          </div>
          <div class="sephira-title">Малхут (Malkuth) — Завод & Физический мир</div>
          <div class="sephira-desc">Реальное воплощение: ЧПУ-плоттеры раскроя, пресс-формы завода в Черноморске, европейский склад в Братиславе и отгрузка продукции.</div>
          <div class="sephira-model">Физическое производство полимеров EVA</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Section 09: Glossary of Terms for Everyday People -->
  <section class="section" id="glossary">
    <div class="section-header">
      <span class="section-num">09</span>
      <h2 class="section-title">Глоссарий терминов: Простыми словами о высоких технологиях EvaLine</h2>
    </div>
    <p class="lead-text">
      Мы создаем передовые автономные технологии и высокоточные полимерные материалы, но говорим с клиентами и партнерами на понятном человеческом языке. Ниже — простое и наглядное объяснение всех 20 ключевых понятий без сложного птичьего жаргона.
    </p>

    <!-- Glossary Interactive Filter Controls -->
    <div class="glossary-controls">
      <div class="glossary-tabs">
        <button class="glossary-tab active" data-glossary-filter="all">Все 20 понятий</button>
        <button class="glossary-tab" data-glossary-filter="ai">🤖 Искусственный интеллект</button>
        <button class="glossary-tab" data-glossary-filter="poly">🏭 Завод и Полимеры</button>
        <button class="glossary-tab" data-glossary-filter="sec">🛡️ Сеть и Безопасность</button>
      </div>
      <div style="flex: 1; max-width: 380px; min-width: 240px;">
        <input type="text" id="glossary-search" class="matrix-search-input" placeholder="🔍 Найти термин (Консилиум, ЭВА, Шор, RAG...)" style="width: 100%;">
      </div>
    </div>

    <!-- Glossary Cards Grid -->
    <div class="glossary-grid" id="glossary-container">
{prerendered_glossary_html}
    </div>
  </section>
...
<script>
  ...
  const RAW_GLOSSARY = {glossary_json_str};
  ...
  function renderGlossary() {{
    ...
    const filtered = RAW_GLOSSARY.filter(item => {{
    ...
    container.innerHTML = filtered.map(g => `
      <div class="glossary-card" data-category="${{g.category}}">
        <div class="glossary-header">
          <div class="glossary-term">${{g.term}}</div>
          <span class="glossary-category-pill ${{g.badgeClass}}">${{g.categoryName}}</span>
        </div>
        <div class="glossary-plain">
          <strong>Простыми словами:</strong> ${{g.plain}}
        </div>
  ...
  function updateRoiCalc() {{
    ...
    // Update labels
    document.getElementById('val-staff').textContent = staff + ' человек';
    document.getElementById('val-tickets').textContent = tickets.toLocaleString('ru-RU') + ' заявок';
    document.getElementById('val-wage').textContent = '$' + wage + ' / час';

    // Business Math:
    // Average human takes ~12 mins (0.2h) per ticket/quote/order.
    // EvaBot handles 85% of queries automatically at negligible token cost (~$0.02).
    ...
    // Monthly platform running cost estimate (hybrid free+paid pool): ~$180 - $350
    ...
    // Payback days (assuming 30-day month)
    ...
    document.getElementById('res-hours').textContent = hoursSaved.toLocaleString('ru-RU') + ' ч/мес';
    document.getElementById('res-roi').textContent = roiPercent.toLocaleString('en-US') + '%';
    document.getElementById('res-payback').textContent = paybackDays + ' дней';
  }}
